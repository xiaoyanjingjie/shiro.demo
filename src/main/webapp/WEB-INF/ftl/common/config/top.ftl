        ...
        <div class="navbar-header">
	     ...
	     <div role="navigation" class="navbar-collapse collapse">
	          ...
	          <ul class="nav navbar-nav" id="topMenu">
				...
				<#--拥有 角色888888（管理员） ||  100002（用户中心）-->
				<@shiro.hasAnyRoles name='888888,100002'>          
				<li class="dropdown ${(index==21)?string('active','')}">
					<a aria-expanded="false" aria-haspopup="true"  role="button" data-toggle="dropdown" class="dropdown-toggle" href="${basePath}/gorgeousturn/gorgeousturnlist.shtml">
						华丽转身<span class="caret"></span>
					</a>
					<ul class="dropdown-menu">
						<@shiro.hasPermission name="/gorgeousturn/gorgeousturnlist.shtml">
							<li><a href="${basePath}/gorgeousturn/gorgeousturnlist.shtml">会议</a></li>
						</@shiro.hasPermission>
